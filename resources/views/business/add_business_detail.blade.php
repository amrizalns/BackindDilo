        ...
        <div class="card-body" style="font-size: small">
          <form method="POST" action="{{route ('insertBusiness',['id'=>$menu->id_menu])}}" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('Business name') ? ' has-error' : '' }}">
              <table>
                ...
                <tr>
                  ...
                  <td><label style="font-size: small"> : </label></td>
                  <td><select class="" name="city">
                    @foreach ($city as $data)
                      <option value="{{$data->id_city}}">{{ $data->city}}</option>
                    @endforeach
                  </select>
                  <label style="font-size: small"></label></td>
                </tr>

                <tr>
                  <td>
                    <label style="font-size: small">Gambar Bisnis</label>
                  </td>
                  <td>
            ...
            <div class="form-group{{ $errors->has('Phone number') ? ' has-error' : '' }}">
              ...
              <input style="font-size: small" id="phone_number" type="number" class="form-control" name="phone" value="{{ old('phone_number') }}" placeholder="Masukkan nomor telefon bisnis anda "required autofocus>
              @if ($errors->has('phone'))
                <span class="help-block">
            ...
            <div class="form-group">
              ...
              <textarea  rows="15"style="font-size: small" id="desc" type="text" class="form-control" name="desc" value="" placeholder="Masukkan Deskripsi Bisnis ( maksimal 250 huruf )"required autofocus></textarea>
            </div>
