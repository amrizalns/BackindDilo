        ...
        <form action="{{ route('userProfileEdit') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('Business name') ? ' has-error' : '' }}">
              <table>
                ...
                <tr>
                  <td>
                    <label style="font-size: small">Kewarganegaraan</label>
                  </td>
                  <td><label style="font-size: small"> : </label></td>
                  <td><input style="font-size:small" id="country" type="text" class="form-control" name="country" value="{{$users->country}}"></td>
                </tr>
                <tr >
                  <td></td>
                  <td></td>
